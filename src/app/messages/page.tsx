  ...
  async function loadMessages() {
    ...
    try {
      ...
      const {
        ...
        .select("*")
        .or(
          `sender_id.eq.${user.id},owner_id.eq.${user.id}`
        )
        .order(
          "created_at",
          {
  ...
  const filtered =
    useMemo(() => {
      return conversations.filter(
        (c) => {
          const keyword =
            `${c.user?.full_name} ${c.machinery?.title} ${c.lastMessage}`
              .toLowerCase();
          ...
          <div className="px-6 pt-6">
            ...
            <div className="bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border border-cyan-500/20 rounded-3xl p-5">
              ...
              <p className="text-zinc-300 text-sm leading-7">
                ...
                AI helps you negotiate faster,
                close more deals,
                and manage machinery buyers intelligently.
                ...
                >
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="mt-3 text-zinc-400 text-sm truncate">
          ...
          {!selectedConversation ? (
            ...
            <>
              ...
              <div className="border-b border-zinc-800 px-8 py-6 bg-zinc-950">
                ...
                <div className="flex items-center justify-between gap-6">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <button className="w-14 h-14 rounded-2xl bg-cyan-500/10 hover:bg-cyan-500/20 flex items-center justify-center transition">
              ...
              <div className="px-8 pt-5">
                ...
                <div className="bg-cyan-500/10 border border-cyan-500/20 rounded-3xl p-5 flex items-start gap-4">

                  <Sparkles className="text-cyan-400 mt-1" />

                  <div>

                    <div className="font-black text-cyan-400 mb-2">
