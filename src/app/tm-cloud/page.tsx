...
export default function TMCloudPage() {
          ...
          <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-10">
            ...
            <div className="max-w-4xl">
              ...
              <p className="text-zinc-300 text-lg leading-8">
                ...
                TM Cloud provides the distributed infrastructure layer for industrial AI,
                digital twins,
                telemetry pipelines,
            ...
            <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-10">
              ...
              <div className="max-w-4xl">
                ...
                <h2 className="text-5xl font-black mb-6 leading-tight">
                  ...
                  TM Cloud powers autonomous industrial intelligence systems

                </h2>

                <p className="text-zinc-300 text-xl leading-9">

                  TM Cloud is the distributed infrastructure backbone enabling AI orchestration,
                  industrial telemetry,
                  digital twins,
