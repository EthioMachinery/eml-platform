...
export default function TMPaymentsPage() {
          ...
          <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-10">
            ...
            <div className="max-w-4xl">
              ...
              <p className="text-zinc-300 text-lg leading-8">
                ...
                TM Payments orchestrates industrial value exchange across procurement,
                logistics,
                governments,
                contractors,
                AI agents,
            ...
            <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-10">
              ...
              <div className="max-w-4xl">
                ...
                <h2 className="text-5xl font-black mb-6 leading-tight">
                  ...
                  TM Payments powers industrial value exchange

                </h2>

                <p className="text-zinc-300 text-xl leading-9">

                  TM Payments transforms TM into a living industrial economy —
