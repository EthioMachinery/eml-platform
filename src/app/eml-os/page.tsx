...
export default function EMLOSPage() {
          ...
          <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-10">
            ...
            <div className="max-w-4xl">
              ...
              <p className="text-zinc-300 text-lg leading-8">
                ...
                EML OS coordinates industrial infrastructure,
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-[35px] p-6">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="Search EML OS modules..."
            ...
            <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-10">
              ...
              <div className="max-w-4xl">
                ...
                <h2 className="text-5xl font-black mb-6 leading-tight">
                  ...
                  EML OS is the intelligence core of the industrial ecosystem

                </h2>

                <p className="text-zinc-300 text-xl leading-9">

                  EML OS transforms fragmented industrial systems into one synchronized,
                  intelligent,
