        ...
        {loading ? (
          ...
          <div className="grid gap-6">
            ...
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="h-36 rounded-3xl bg-zinc-900 animate-pulse"
              />
            ))}
                      ...
                      <div className="flex items-start gap-5">
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap items-center gap-3 mb-3">
                            ...
                            <div
                              className={`px-4 py-1 rounded-full border text-sm font-bold ${statusBadge(
                                tx.status
                              )}`}
                            >
                              {tx.status}
                          ...
                          <div className="text-zinc-400 leading-8 max-w-3xl">
                            {tx.note ||
                              t(
                                "EML Machinery Ecosystem Transaction",
                                "የEML የማሽነሪ ስርዓት ግብይት"
                              )}
                          </div>
