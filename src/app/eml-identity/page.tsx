...
export default function EMLIdentityPage() {
          ...
          <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-10">
            ...
            <div className="max-w-4xl">
              ...
              <p className="text-zinc-300 text-lg leading-8">
                ...
                and infrastructure-level security across the EML ecosystem.
            ...
            <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-10">
              ...
              <div className="max-w-4xl">
                ...
                <h2 className="text-5xl font-black mb-6 leading-tight">
                  ...
                  EML Identity secures the industrial intelligence ecosystem

                </h2>

                <p className="text-zinc-300 text-xl leading-9">

                  EML Identity establishes the sovereign trust layer enabling secure industrial operations,
                  AI governance,
                  enterprise identity,
