const ti: Record<string, any> = {
  ...
  heroDescription: "TM ናይ ማሽነሪ ዋናታት፣ ኮንትራክተራት፣ ናይ መጓዓዝቲ ኣቕረብቲ፣ ኦፕሬተራት፣ መካኒካት፣ ኢንሹሮ፣ ናይ መተካእታ ኣቕረብቲን ናይ ኢንዱስትሪ ዕዮዎትን ኣብ ሓደ ስርዓት የጣምር።",
  ...
  ecosystem: "ናይ TM ስርዓት",
  everythingIndustrialBusinessesNeed: "ናይ ኢንዱስትሪ ዕዮዎት ዘድልዮ ዅሉ",
  ecosystemDescription: "TM ናይ ኢትዮጵያ ኢንዱስትሪ ዲጂታላዊ ፕላትፎርም ክህነጽ ኣሎ — ማሽነሪ፣ መጓዓዝቲ፣ ኦፕሬተራት፣ መካኒካት፣ ፋይናንስን ናይ ኢንዱስትሪ ኣገልግሎታትን የጣምር።",
